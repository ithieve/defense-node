...
public class MainMenuScreen implements Screen {
    ...
    private boolean checkName(String name) {
        ...
        //check using regex for invalid characters
    ...
    private void setup() {
        ...
        menuTable.align(Align.center | Align.top);         // Center the ui
        menuTable.setPosition(0, MainGame.GENERAL_HEIGHT); // to fill screen
