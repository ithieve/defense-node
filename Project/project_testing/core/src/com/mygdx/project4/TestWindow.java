...
public class TestWindow implements Screen {
    ...
    public void show() {
        ...
        //   Gdx.app.log("LoadingScreen","this is a test log");
...
//                false);
 ...
 //       camera.viewportHeight = 480;
   //     camera.viewportWidth= 640;
        //Gdx.app.log("LoadingScreen","Resize to " + (width/2) + " x " + (float)height/2);
        //Gdx.app.log("LoadingScreen","Resize to " + viewport.getScreenHeight() + " x " + viewport.getScreenWidth());
